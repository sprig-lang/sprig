...
sp_Future*  sp_scheduleWithArg(sp_Scheduler* sch, sp_Task* task, void* arg, sp_TimeSpan delay, sp_Promise* p);
sp_Future*  sp_scheduleWithObjectArg(sp_Scheduler* sch, sp_Task* task, sp_Ptr arg, sp_TimeSpan delay, sp_Promise* p);
